...
class AuthController extends GetxController {
  ...
  Future<void> register(String name, String email, String password) async {
    ...
    final AuthResponse response = await authService.auth.signUp(email: email, password: password, data: {"name": name});
  ...
  Future<void> login(String email, String password, BuildContext context) async {
    ...
    try {
      final AuthResponse response = await authService.auth.signInWithPassword(email: email, password: password);
