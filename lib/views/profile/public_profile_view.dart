                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        CircularProfileImageWidget(
                          ...
                          radius: 40,
                          onTap: (){
                            if (controller.user.value!.id != controller.uid) {
                              Get.toNamed(RouteNames.showProfile, arguments: controller.uid);
                            }
                          },
                        ),
                      ],
                      ...
                      ? ListView.builder(
                          ...
                          itemBuilder: (_, index) {
                            ...
                            return ThreadCardWidget(
                              ...
                              isLiked:
                                  controller.threadLikeService.isThreadLiked,
                          ...
                          itemBuilder: (_, index) => ThreadReplyWidget(
                            ...
                            onTap: () {
                              Get.toNamed(
                                RouteNames.thread,
                                arguments:
                                    controller.repliedThreads[index].thread.id,
                              );
                            },
                          ),
                        )
